    ...
    glfwSetKeyCallback(window, [](GLFWwindow*, int key, int /*scancode*/,
        ...
        auto convert = [](int glfw_key) -> keyboard::Key {
            switch (glfw_key) {
                ...
                case GLFW_KEY_1:
                    return keyboard::Key::d1;
                case GLFW_KEY_2:
                    return keyboard::Key::d2;
                case GLFW_KEY_3:
                    return keyboard::Key::d3;
                case GLFW_KEY_4:
                    return keyboard::Key::d4;
                case GLFW_KEY_5:
                    return keyboard::Key::d5;
                case GLFW_KEY_6:
                    return keyboard::Key::d6;
                case GLFW_KEY_7:
                    return keyboard::Key::d7;
                case GLFW_KEY_8:
                    return keyboard::Key::d8;
                case GLFW_KEY_9:
                    return keyboard::Key::d9;
                case GLFW_KEY_0:
                    return keyboard::Key::d0;
                case GLFW_KEY_MINUS:
